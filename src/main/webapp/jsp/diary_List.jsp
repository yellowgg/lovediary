            ...
            <div class="st-content"
                ...
                <div class="st-content-inner">
                    ...
                    <div class="col-md-12">
                        ...
                        <%--日记列表--%>
                        <div id="diaryMiddleList" class="col-md-6" style="height: 100%">
                            ...
                            <c:if test="${not empty diariesOfTopCate.data}">
                                <c:forEach items="${diariesOfTopCate.data}" var="d">
                                    <div class="day">
                                        ...
                                        <div class="diaryTitle">
                                            <a href="<%=basePath%>/diary/info/${d.diaryid}"
                                               class="postTitle2">${d.diarytitle}</a>
                                        </div>
                                ...
                                <div style="width:200px;margin:0 auto;margin-top:130px;">
                                    <ul class="pagination" style="text-align:center; margin-top:10px;">
                                        ...
                                        <c:if test="${diariesOfTopCate.pageNumber != 1 }">
                                            <li>
                                                <a href="<%=basePath%>/diary/findPage/${diariesOfTopCate.pageNumber-1}&${typeId}"
                                                   aria-label="Previous">
                                                    <span aria-hidden="true">&laquo;</span>
                                                </a>
                                            </li>
                                        ...
                                        <c:forEach begin="1" end="${diariesOfTopCate.totalPage }" var="n">
                                            ...
                                            <%--不是的话就只显示数字并且能跳转--%>
                                            <c:if test="${diariesOfTopCate.pageNumber != n }">
                                                <li><a href="<%=basePath%>/diary/findPage/${n}&${typeId}">${n }</a>
                                                </li>
                                            </c:if>
                                        </c:forEach>
