            ...
            <div class="st-content"
                ...
                <div class="st-content-inner">
                    ...
                    <div class="col-md-12">
                        ...
                        <%--日记编辑--%>
                        <div id="diaryMiddleEdit" class="col-md-6"
                             style="height: 100%">
                            <form class="form-horizontal" method="post"
                                  style="width: 100%;margin: 30px 1px 1px;"
                                  action="<%=basePath%>/diary/editDiary">
                                <div class="form-group">
                                    <label for="diarytitle" style="font-size:20px" class="col-sm-2 control-label">标题
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" value="${currentDiary.diarytitle}" name="diarytitle"
                                               class="form-control input-lg" id="diarytitle" required
                                               placeholder="每日一句情话">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" value="${currentDiary.diarysubtitle}"
                                               class="form-control input-lg" id="diarysubtitle"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control input-lg" rows="10" style="resize: none"
                                                  ...
                                                  id="diarycontent">${currentDiary.diarycontent}</textarea>
                                    </div>
                                </div>
                                <button type="submit" class="btn btn-primary btn-lg"
                                        style="background-color: #1380ab;margin: 10px 45%">保存
                                </button>
                                <input type="hidden" name="diaryid" value="${currentDiary.diaryid}">
                            </form>
                        </div>
                        <%--右边空白,已抽取，静态包含--%>
